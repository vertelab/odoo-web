odoo.define('web_form_search.FormSearchView', function (require) {
    "use strict";
    ...
    var FormSearchRenderer = require('web_form_search.FormSearchRenderer');
    var viewRegistry = require('web.view_registry');

    var _lt = core._lt;

    var FormSearchView = BasicView.extend({
        config: _.extend({}, BasicView.prototype.config, {
            Renderer: FormSearchRenderer,
            Controller: FormSearchController,
        }),
        display_name: _lt('Form Search'),
        icon: 'fa-search',
        multi_record: false,
        searchable: true,
        jsLibs: [],
    ...
    viewRegistry.add('form_search', FormSearchView);
