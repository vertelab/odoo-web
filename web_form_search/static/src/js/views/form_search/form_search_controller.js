odoo.define('web_form_search.FormSearchController', function (require) {
    "use strict";
    ...
    var FormSearchController = BasicController.extend({
        ...
        update: function (params, options) {
            params = _.extend({viewType: 'form_search', mode: this.mode}, params);
