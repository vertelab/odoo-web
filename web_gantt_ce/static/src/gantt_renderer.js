...
export class GanttRenderer extends Component {
    ...
    static connectorCreatorTemplate = "web_gantt_ce.GanttRenderer.ConnectorCreator";
    static headerTemplate = "web_gantt_ce.GanttRenderer.Header";
    static pillTemplate = "web_gantt_ce.GanttRenderer.Pill";
    static groupPillTemplate = "web_gantt_ce.GanttRenderer.GroupPill";
    static rowContentTemplate = "web_gantt_ce.GanttRenderer.RowContent";
    static rowHeaderTemplate = "web_gantt_ce.GanttRenderer.RowHeader";
    static totalRowTemplate = "web_gantt_ce.GanttRenderer.TotalRow";
