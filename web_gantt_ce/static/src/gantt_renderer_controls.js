...
export class GanttRendererControls extends Component {
    static template = "web_gantt_ce.GanttRendererControls";
    static components = {
        Dropdown,
        DropdownItem,
        GanttScaleSelector,
    ...
    static toolbarContentTemplate = "web_gantt_ce.GanttRendererControls.ToolbarContent";
    static rangeMenuTemplate = "web_gantt_ce.GanttRendererControls.RangeMenu";
